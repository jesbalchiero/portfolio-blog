<template>
    ...
    <p class="text-lg">
      ...
      <a href="https://wesbos.com/uses" aria-label="Wes Bos Uses">Wes Bos</a>'s uses page and has been submitted to
    ...
    <ul class="list-disc">
        ...
        <li class="ml-8 py-1">
            ...
            <a href="https://marketplace.visualstudio.com/items?itemName=RobbOwen.synthwave-vscode" aria-label="Synthwave 84 by Robb Owen">Synthwave 84</a> by Robb Owen.
        </li>
        <li class="ml-8 py-1">
            Font is <a href="https://sourcefoundry.org/hack/" aria-label="Hack Font">Hack</a>
        </li>
        <li class="ml-8 py-1">
